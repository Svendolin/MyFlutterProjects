    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Column( // Column Widget, damit die Texte untereinander angeordnet werden
            crossAxisAlignment: CrossAxisAlignment.start, // Texte linksbündig
            children: [
              const Padding(
              ...
              const SizedBox(height: 15,), // Sorgt für einen Abstand zwischen dem Text und dem Container in vertikaler Column Distamnz
              Container(
                height: 150,
                color: Colors.green,
